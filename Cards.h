...
Card::Card(string memberName, string accountNumber, double balance, string cardName, double creditLimit, vector<Expense> expenses) : 
	
	Account(memberName, accountNumber, balance, expenses), cardName(cardName), creditLimit(creditLimit) {}
