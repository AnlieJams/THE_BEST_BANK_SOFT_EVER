...
Account::Account(string memberName, string accountNumber, double balance, vector<Expense> expenses) : 
		memberName(memberName), accountNumber(accountNumber), balance(balance), expenses(expenses) {}